...
public abstract class SPosition <N extends Number> implements Position<N> {
    ...
    public static final Function<? extends Location<? extends World<?>>, SBlockPosition> TO_SYNCED_BLOCK_POSITION = ((l) -> new SBlockPosition(l));
    public static final Function<? extends Location<? extends World<?>>, SExactPosition> TO_SYNCED_EXACT_POSITION = ((l) -> new SExactPosition(l));
    ...
    public WorldExtent getWorld() {
        return new SWorldExtent(this.location.getWorld());
    }
