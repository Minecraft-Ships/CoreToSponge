...
public class SLoadedChunkExtent implements ChunkExtent, AsyncChunk {
    ...
    public Vector3<Integer> getChunkPosition() {
        Vector3i pos = this.chunk.chunkPosition();
        return Vector3.valueOf(pos.x(), pos.y(), pos.z());
    }

    @Override
    public Vector3<Integer> getMinimumBlock() {
        Vector3i pos = this.chunk.min();
        return Vector3.valueOf(pos.x(), pos.y(), pos.z());
    }

    @Override
    public Vector3<Integer> getMaximumBlock() {
        Vector3i pos = this.chunk.max();
        return Vector3.valueOf(pos.x(), pos.y(), pos.z());
    }
    ...
    public BlockDetails getDetails(@NotNull Vector3<Integer> vector) {
        return this.getPosition(vector).getBlockDetails();
    }
}
